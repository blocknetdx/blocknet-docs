...
```
[Main]
ExchangeWallets=ALQO,BITG,BLOCK,BTC,BWK,COLX,CRAVE,CRC,CRW,DASH,DGB,DMD,DOGE,DYN,EMC2,ENT,FAIR,FLO,GBX,HTML,HXX,INN,IOP,KLKS,LBC,LTC,LYNX,MGN,MNX,MONA,MUE,NMC,OHM,ORE,PHR,PIVX,PURA,QBIC,QTUM,RVN,SEND,SPK,SUCR,SYS,TRB,TRC,UNB,UNO,VIA,VITAE,VIVO,VSX,VTC,WGR,XC,XMY,XSN,XZC,ZOI
FullLog=true
LogPath=
ExchangeTax=300
