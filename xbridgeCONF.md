...
```
[Main]
ExchangeWallets=BITG,BLOCK,BTC,BWK,COLX,CRW,DASH,DGB,DMD,DOGE,DYN,EMC2,FAIR,FLO,GBX,HTML,HXX,INN,IOP,KLKS,LBC,LTC,MNX,MONA,MUE,NMC,ORE,PHR,PIVX,PURA,QTUM,SEND,SYS,TRC,UNB,UNO,VIA,VIT,VIVO,VSX,VTC,WGR,XC,XSN,XZC,ZOI
FullLog=true
LogPath=
ExchangeTax=300
