...
```
[Main]
ExchangeWallets=AEX,ALQO,BANQ,BITG,BLAST,BLOCK,BTC,BWK,COLX,CRAVE,CRC,CRW,DASH,DGB,DMD,DOGE,DYN,EMC2,ENT,FAIR,FLO,GBX,HTML,HXX,INN,IOP,KLKS,KREDS,LBC,LTC,LYNX,MGN,MNX,MONA,MUE,NMC,NORT,NYX,OHM,ORE,PHR,PIVX,PURA,QBIC,QTUM,RVN,SEND,SPK,SUCR,SYS,TRB,TRC,UCOM,UFO,UNB,UNO,VIA,VITAE,VIVO,VSX,VTC,WGR,XC,XMCC,XMY,XN,XSN,XZC,ZOI
FullLog=true
LogPath=
ExchangeTax=300
