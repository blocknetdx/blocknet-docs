...
```
[Main]
ExchangeWallets=ALQO,BITG,BLOCK,BTC,BWK,COLX,CRAVE,CRC,CRW,DASH,DGB,DMD,DOGE,DYN,EMC2,FAIR,FLO,GBX,HTML,HXX,INN,IOP,KLKS,LBC,LTC,LYNX,MNX,MONA,MUE,NMC,ORE,PHR,PIVX,PURA,QBIC,QTUM,SEND,SPK,SUCR,SYS,TRC,UNB,UNO,VIA,VITAE,VIVO,VSX,VTC,WGR,XC,XMY,XSN,XZC,ZOI
FullLog=true
LogPath=
ExchangeTax=300
